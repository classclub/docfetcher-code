...
public enum Msg {
	...
	docfetcher_pro_tip ("You may be interested in DocFetcher Pro, the commercial big brother of DocFetcher with more features and fewer bugs."),
	dont_show_msg_again ("Don't show this message again."),
